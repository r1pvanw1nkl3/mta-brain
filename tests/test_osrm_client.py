...
async def test_get_walk_times_success(osrm_client, mock_http_client):
    ...
    # distances are mock durations in seconds
    mock_response.json.return_value = {"durations": [[0, 300.5, 600.0]]}
    ...
    mock_http_client.get.assert_called_once_with(
        "http://osrm.test/table/v1/foot/-73.98,40.75;-73.981,40.751;-73.982,40.752?sources=0"
    )
